...
#include "mrs_msgs/msg/detail/limits__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::Limits & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::Limits & ros_message)
{
  // Member: a_max
  cdr >> ros_message.a_max;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::Limits;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::Limits *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::Limits *>(
    untyped_ros_message);
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_Limits__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, Limits)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_Limits__handle;
}
