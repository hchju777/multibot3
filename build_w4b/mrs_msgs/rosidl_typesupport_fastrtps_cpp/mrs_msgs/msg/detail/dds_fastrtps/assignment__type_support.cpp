...
#include "mrs_msgs/msg/detail/assignment__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mrs_msgs::msg::RobotAssignment &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mrs_msgs::msg::RobotAssignment &);
size_t get_serialized_size(
  const mrs_msgs::msg::RobotAssignment &,
  size_t current_alignment);
size_t
max_serialized_size_RobotAssignment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_RobotAssignment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const mrs_msgs::msg::Assignment & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.unassigned_tasks;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::Assignment & ros_message)
{
  // Member: schema
  cdr >> ros_message.schema;
  ...
  // Member: assignments
  {
    ...
    ros_message.assignments.resize(size);
    for (size_t i = 0; i < size; i++) {
      mrs_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.assignments[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: assignments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.assignments[index], current_alignment);
    }
  }
  ...
  // Member: unassigned_tasks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.unassigned_tasks[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: assignments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RobotAssignment(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::Assignment;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: assignments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_RobotAssignment(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::Assignment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::Assignment *>(
    untyped_ros_message);
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_Assignment__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, Assignment)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_Assignment__handle;
}
