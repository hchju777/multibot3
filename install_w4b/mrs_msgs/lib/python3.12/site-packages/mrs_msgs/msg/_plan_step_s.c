...
bool mrs_msgs__msg__plan_step__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._plan_step.PlanStep", full_classname_dest, 32) == 0);
  }
  mrs_msgs__msg__PlanStep * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of PlanStep */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._plan_step");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanStep");
