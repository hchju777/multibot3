...
class Metaclass_DiscretePlan(type):
    """Metaclass of message 'DiscretePlan'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mrs_msgs.msg.DiscretePlan')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__discrete_plan
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__discrete_plan
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__discrete_plan
            cls._TYPE_SUPPORT = module.type_support_msg__msg__discrete_plan
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__discrete_plan

            from mrs_msgs.msg import RobotPlan
            if RobotPlan.__class__._TYPE_SUPPORT is None:
                RobotPlan.__class__.__import_type_support__()
...
class DiscretePlan(metaclass=Metaclass_DiscretePlan):
    """Message class 'DiscretePlan'."""
    ...
    _fields_and_field_types = {
        ...
        'plans': 'sequence<mrs_msgs/RobotPlan>',
        'visit_order': 'sequence<mrs_msgs/VisitOrder>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mrs_msgs', 'msg'], 'RobotPlan')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.visit_order = kwargs.get('visit_order', [])
    ...
    def __eq__(self, other):
        ...
        if self.plans != other.plans:
            return False
        if self.visit_order != other.visit_order:
            return False
        return True
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, RobotPlan) for v in value) and
                 True), \
                "The 'plans' field must be a set or sequence and each value of type 'RobotPlan'"
        self._plans = value

    @builtins.property
    def visit_order(self):
        """Message field 'visit_order'."""
        return self._visit_order

    @visit_order.setter
    def visit_order(self, value):
        if self._check_fields:
            from mrs_msgs.msg import VisitOrder
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'visit_order' field must be a set or sequence and each value of type 'VisitOrder'"
        self._visit_order = value
