...
class Metaclass_GoalCompletion(type):
    """Metaclass of message 'GoalCompletion'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mrs_msgs.msg.GoalCompletion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__goal_completion
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__goal_completion
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__goal_completion
            cls._TYPE_SUPPORT = module.type_support_msg__msg__goal_completion
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__goal_completion
...
class GoalCompletion(metaclass=Metaclass_GoalCompletion):
    """Message class 'GoalCompletion'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.goal_id = kwargs.get('goal_id', str())
    ...
    def goal_id(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'goal_id' field must be of type 'str'"
        self._goal_id = value
