...
class Metaclass_Assignment(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mrs_msgs.msg import RobotAssignment
            if RobotAssignment.__class__._TYPE_SUPPORT is None:
                RobotAssignment.__class__.__import_type_support__()
...
class Assignment(metaclass=Metaclass_Assignment):
    ...
    _fields_and_field_types = {
        ...
        'instance_id': 'string',
        'revision': 'uint64',
        'assignments': 'sequence<mrs_msgs/RobotAssignment>',
        'unassigned_tasks': 'sequence<string>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mrs_msgs', 'msg'], 'RobotAssignment')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.unassigned_tasks = kwargs.get('unassigned_tasks', [])
    ...
    def __eq__(self, other):
        ...
        if self.assignments != other.assignments:
            return False
        if self.unassigned_tasks != other.unassigned_tasks:
            return False
        return True
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, RobotAssignment) for v in value) and
                 True), \
                "The 'assignments' field must be a set or sequence and each value of type 'RobotAssignment'"
        self._assignments = value

    @builtins.property
    def unassigned_tasks(self):
        """Message field 'unassigned_tasks'."""
        return self._unassigned_tasks

    @unassigned_tasks.setter
    def unassigned_tasks(self, value):
        if self._check_fields:
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'unassigned_tasks' field must be a set or sequence and each value of type 'str'"
        self._unassigned_tasks = value
