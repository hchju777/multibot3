...
#include "mrs_msgs/msg/detail/dependency__rosidl_typesupport_fastrtps_c.h"
...
using _Dependency__ros_msg_type = mrs_msgs__msg__Dependency;
...
{
  const _Dependency__ros_msg_type * ros_message = static_cast<const _Dependency__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__Dependency;
    is_plain =
      (
...
static bool _Dependency__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__Dependency * ros_message = static_cast<const mrs_msgs__msg__Dependency *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__Dependency(ros_message, cdr);
}

static bool _Dependency__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__Dependency * ros_message = static_cast<mrs_msgs__msg__Dependency *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__Dependency(cdr, ros_message);
}

static uint32_t _Dependency__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__Dependency(
      untyped_ros_message, 0));
}

static size_t _Dependency__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mrs_msgs__msg__Dependency(
...
static message_type_support_callbacks_t __callbacks_Dependency = {
  "mrs_msgs::msg",
  "Dependency",
  _Dependency__cdr_serialize,
  _Dependency__cdr_deserialize,
  _Dependency__get_serialized_size,
  _Dependency__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _Dependency__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Dependency,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, Dependency)() {
  return &_Dependency__type_support;
}
