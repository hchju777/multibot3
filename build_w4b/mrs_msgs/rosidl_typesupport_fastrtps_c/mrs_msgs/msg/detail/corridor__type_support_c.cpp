...
#include "mrs_msgs/msg/detail/corridor__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_msgs/msg/detail/edge_ref__functions.h"  // edges
...
using _Corridor__ros_msg_type = mrs_msgs__msg__Corridor;
  ...
  mrs_msgs__msg__Corridor * ros_message)
{
  ...
  // Field name: edges
  {
    ...
    if (ros_message->edges.data) {
      mrs_msgs__msg__EdgeRef__Sequence__fini(&ros_message->edges);
    }
...
size_t get_serialized_size_mrs_msgs__msg__Corridor(
  ...
  size_t current_alignment)
{
  const _Corridor__ros_msg_type * ros_message = static_cast<const _Corridor__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__Corridor;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__Corridor * ros_message = static_cast<const mrs_msgs__msg__Corridor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__Corridor(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__Corridor * ros_message = static_cast<mrs_msgs__msg__Corridor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__Corridor(cdr, ros_message);
}

static uint32_t _Corridor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__Corridor(
...
static size_t _Corridor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__Corridor(
...
static message_type_support_callbacks_t __callbacks_Corridor = {
  "mrs_msgs::msg",
  "Corridor",
...
static rosidl_message_type_support_t _Corridor__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Corridor,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, Corridor)() {
  return &_Corridor__type_support;
}
