...
{
  new (message_memory) mrs_msgs::msg::OperatorCommand(_init);
}

void OperatorCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrs_msgs::msg::OperatorCommand *>(message_memory);
  typed_message->~OperatorCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember OperatorCommand_message_member_array[7] = {
  {
    "seq",  // name
    ...
    offsetof(mrs_msgs::msg::OperatorCommand, seq),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::OperatorCommand, robot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::OperatorCommand, verb),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::OperatorCommand, active),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::OperatorCommand, speed_cap_mps),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::OperatorCommand, has_speed_cap_mps),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrs_msgs::msg::OperatorCommand, goal_location),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OperatorCommand_message_members = {
  ...
  7,  // number of fields
  sizeof(mrs_msgs::msg::OperatorCommand),
...
{
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::OperatorCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrs_msgs, msg, OperatorCommand)() {
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::OperatorCommand_message_type_support_handle;
}
