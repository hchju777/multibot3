...
{
  new (message_memory) mrs_msgs::msg::StopReason(_init);
}

void StopReason_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrs_msgs::msg::StopReason *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StopReason_message_member_array[1] = {
  {
    ...
    offsetof(mrs_msgs::msg::StopReason, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StopReason_message_members = {
  ...
  1,  // number of fields
  sizeof(mrs_msgs::msg::StopReason),
...
{
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::StopReason_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrs_msgs, msg, StopReason)() {
  return &::mrs_msgs::msg::rosidl_typesupport_introspection_cpp::StopReason_message_type_support_handle;
}
