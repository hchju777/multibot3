...
bool mrs_msgs__msg__task_goal__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * mrs_msgs__msg__task_goal__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool mrs_msgs__msg__task_release__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._task_release.TaskRelease", full_classname_dest, 38) == 0);
  }
  mrs_msgs__msg__TaskRelease * ros_message = _ros_message;
  {  // schema
  ...
  {  // release_index
    PyObject * field = PyObject_GetAttrString(_pymsg, "release_index");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->release_index = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // task
  ...
  {  // goals
    ...
    if (!mrs_msgs__msg__TaskGoal__Sequence__init(&(ros_message->goals), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mrs_msgs__msg__TaskGoal__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mrs_msgs__msg__TaskGoal * dest = ros_message->goals.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mrs_msgs__msg__task_goal__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of TaskRelease */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._task_release");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskRelease");
  ...
  {  // release_index
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->release_index);
    {
      int rc = PyObject_SetAttrString(_pymessage, "release_index", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // goals
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mrs_msgs__msg__task_goal__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
