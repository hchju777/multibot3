...
bool mrs_msgs__msg__visit_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._visit_item.VisitItem", full_classname_dest, 34) == 0);
  }
  mrs_msgs__msg__VisitItem * ros_message = _ros_message;
  {  // robot
...
{
  /* NOTE(esteve): Call constructor of VisitItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._visit_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VisitItem");
