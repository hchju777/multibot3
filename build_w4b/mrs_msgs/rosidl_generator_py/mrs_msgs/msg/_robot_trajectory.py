...
class Metaclass_RobotTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mrs_msgs.msg import TrajectoryPoint
...
class RobotTrajectory(metaclass=Metaclass_RobotTrajectory):
    ...
    _fields_and_field_types = {
        'robot': 'string',
        'points': 'sequence<mrs_msgs/TrajectoryPoint>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mrs_msgs', 'msg'], 'TrajectoryPoint')),  # noqa: E501
    )
