...
bool mrs_msgs__msg__edge_ref__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._edge_ref.EdgeRef", full_classname_dest, 30) == 0);
  }
  mrs_msgs__msg__EdgeRef * ros_message = _ros_message;
  {  // from_id
...
{
  /* NOTE(esteve): Call constructor of EdgeRef */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._edge_ref");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EdgeRef");
