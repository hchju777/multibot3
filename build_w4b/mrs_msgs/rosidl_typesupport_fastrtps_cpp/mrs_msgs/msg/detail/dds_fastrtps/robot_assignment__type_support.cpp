...
#include "mrs_msgs/msg/detail/robot_assignment__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::RobotAssignment & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::RobotAssignment & ros_message)
{
  // Member: robot
  cdr >> ros_message.robot;
  ...
  size_t current_alignment)
{
  ...
  // Member: goals
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Goal(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::RobotAssignment;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: goals
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RobotAssignment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::RobotAssignment *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotAssignment__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RobotAssignment *>(
...
static size_t _RobotAssignment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotAssignment(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotAssignment__callbacks = {
  "mrs_msgs::msg",
  "RobotAssignment",
...
static rosidl_message_type_support_t _RobotAssignment__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotAssignment__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RobotAssignment__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, RobotAssignment)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RobotAssignment__handle;
}
