...
bool mrs_msgs__msg__segment_release_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._segment_release_item.SegmentReleaseItem", full_classname_dest, 53) == 0);
  }
  mrs_msgs__msg__SegmentReleaseItem * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of SegmentReleaseItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._segment_release_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SegmentReleaseItem");
