...
bool mrs_msgs__msg__robot_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * mrs_msgs__msg__robot_trajectory__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool mrs_msgs__msg__trajectories__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._trajectories.Trajectories", full_classname_dest, 39) == 0);
  }
  mrs_msgs__msg__Trajectories * ros_message = _ros_message;
  {  // schema
  ...
  {  // limits
    ...
    if (!mrs_msgs__msg__limits__convert_from_py(field, &ros_message->limits)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // trajectories
    ...
    if (!mrs_msgs__msg__RobotTrajectory__Sequence__init(&(ros_message->trajectories), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mrs_msgs__msg__RobotTrajectory__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mrs_msgs__msg__RobotTrajectory * dest = ros_message->trajectories.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mrs_msgs__msg__robot_trajectory__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of Trajectories */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._trajectories");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Trajectories");
  ...
  {  // limits
    PyObject * field = NULL;
    field = mrs_msgs__msg__limits__convert_to_py(&ros_message->limits);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // trajectories
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mrs_msgs__msg__robot_trajectory__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
