...
#include "mrs_msgs/msg/detail/visit_order__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mrs_msgs::msg::VisitItem &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mrs_msgs::msg::VisitItem &);
...
cdr_serialize(
  const mrs_msgs::msg::VisitOrder & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::VisitOrder & ros_message)
{
  // Member: location
  cdr >> ros_message.location;
  ...
  size_t current_alignment)
{
  ...
  // Member: sequence
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VisitItem(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::VisitOrder;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: sequence
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_VisitItem(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::VisitOrder *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::VisitOrder *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VisitOrder__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::VisitOrder *>(
...
static size_t _VisitOrder__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VisitOrder(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VisitOrder__callbacks = {
  "mrs_msgs::msg",
  "VisitOrder",
...
static rosidl_message_type_support_t _VisitOrder__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VisitOrder__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_VisitOrder__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, VisitOrder)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_VisitOrder__handle;
}
