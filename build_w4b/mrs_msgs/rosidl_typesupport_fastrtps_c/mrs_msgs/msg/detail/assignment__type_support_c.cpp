...
#include "mrs_msgs/msg/detail/assignment__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_msgs/msg/detail/robot_assignment__functions.h"  // assignments
#include "rosidl_runtime_c/string.h"  // instance_id, schema, schema_version, unassigned_tasks
#include "rosidl_runtime_c/string_functions.h"  // instance_id, schema, schema_version, unassigned_tasks
...
using _Assignment__ros_msg_type = mrs_msgs__msg__Assignment;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_mrs_msgs__msg__Assignment(
  const mrs_msgs__msg__Assignment * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: schema
  {
  ...
  // Field name: assignments
  {
    ...
    auto array_ptr = ros_message->assignments.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_msgs__msg__RobotAssignment(
        &array_ptr[i], cdr);
    }
  }

  // Field name: unassigned_tasks
  {
    size_t size = ros_message->unassigned_tasks.size;
    auto array_ptr = ros_message->unassigned_tasks.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_deserialize_mrs_msgs__msg__Assignment(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs__msg__Assignment * ros_message)
{
  // Field name: schema
  {
    std::string tmp;
  ...
  // Field name: assignments
  {
    ...
    if (ros_message->assignments.data) {
      mrs_msgs__msg__RobotAssignment__Sequence__fini(&ros_message->assignments);
    }
    if (!mrs_msgs__msg__RobotAssignment__Sequence__init(&ros_message->assignments, size)) {
      fprintf(stderr, "failed to create array for field 'assignments'");
      return false;
    }
    auto array_ptr = ros_message->assignments.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_msgs__msg__RobotAssignment(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: unassigned_tasks
  {
    ...
    if (ros_message->unassigned_tasks.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->unassigned_tasks);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->unassigned_tasks, size)) {
      fprintf(stderr, "failed to create array for field 'unassigned_tasks'");
      return false;
    }
    auto array_ptr = ros_message->unassigned_tasks.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'unassigned_tasks'\n");
        return false;
      }
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_mrs_msgs__msg__Assignment(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: assignments
  {
    size_t array_size = ros_message->assignments.size;
    auto array_ptr = ros_message->assignments.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_msgs__msg__RobotAssignment(
  ...
  // Field name: unassigned_tasks
  {
    size_t array_size = ros_message->unassigned_tasks.size;
    auto array_ptr = ros_message->unassigned_tasks.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_mrs_msgs__msg__Assignment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: assignments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_msgs__msg__RobotAssignment(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__Assignment;
    is_plain =
      (
      offsetof(DataType, unassigned_tasks) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_key_mrs_msgs__msg__Assignment(
  const mrs_msgs__msg__Assignment * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: schema
  ...
  // Field name: assignments
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_msgs__msg__RobotAssignment(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_key_mrs_msgs__msg__Assignment(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Assignment__ros_msg_type * ros_message = static_cast<const _Assignment__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: assignments
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_msgs__msg__RobotAssignment(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_key_mrs_msgs__msg__Assignment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: assignments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_msgs__msg__RobotAssignment(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__Assignment * ros_message = static_cast<const mrs_msgs__msg__Assignment *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__Assignment(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__Assignment * ros_message = static_cast<mrs_msgs__msg__Assignment *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__Assignment(cdr, ros_message);
}

static uint32_t _Assignment__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__Assignment(
...
static size_t _Assignment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__Assignment(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, Assignment)() {
