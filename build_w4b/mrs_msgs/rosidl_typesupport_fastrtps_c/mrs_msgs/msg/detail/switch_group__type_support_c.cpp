...
#include "mrs_msgs/msg/detail/switch_group__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_msgs/msg/detail/alternative__functions.h"  // alternatives
#include "rosidl_runtime_c/string.h"  // id, location
#include "rosidl_runtime_c/string_functions.h"  // id, location
...
using _SwitchGroup__ros_msg_type = mrs_msgs__msg__SwitchGroup;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: alternatives
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_msgs__msg__Alternative(
        &array_ptr[i], cdr);
    }
  }
  ...
  mrs_msgs__msg__SwitchGroup * ros_message)
{
  ...
  // Field name: alternatives
  {
    ...
    if (ros_message->alternatives.data) {
      mrs_msgs__msg__Alternative__Sequence__fini(&ros_message->alternatives);
    }
    if (!mrs_msgs__msg__Alternative__Sequence__init(&ros_message->alternatives, size)) {
      fprintf(stderr, "failed to create array for field 'alternatives'");
      return false;
    }
    auto array_ptr = ros_message->alternatives.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_msgs__msg__Alternative(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_mrs_msgs__msg__SwitchGroup(
  ...
  size_t current_alignment)
{
  const _SwitchGroup__ros_msg_type * ros_message = static_cast<const _SwitchGroup__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: alternatives
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_msgs__msg__Alternative(
  ...
  size_t current_alignment)
{
  ...
  // Field name: alternatives
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_msgs__msg__Alternative(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__SwitchGroup;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: alternatives
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_msgs__msg__Alternative(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: alternatives
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_msgs__msg__Alternative(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: alternatives
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_msgs__msg__Alternative(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _SwitchGroup__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__SwitchGroup * ros_message = static_cast<const mrs_msgs__msg__SwitchGroup *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__SwitchGroup(ros_message, cdr);
}

static bool _SwitchGroup__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__SwitchGroup * ros_message = static_cast<mrs_msgs__msg__SwitchGroup *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__SwitchGroup(cdr, ros_message);
}

static uint32_t _SwitchGroup__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__SwitchGroup(
      untyped_ros_message, 0));
}

static size_t _SwitchGroup__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mrs_msgs__msg__SwitchGroup(
...
static message_type_support_callbacks_t __callbacks_SwitchGroup = {
  "mrs_msgs::msg",
  "SwitchGroup",
  _SwitchGroup__cdr_serialize,
  _SwitchGroup__cdr_deserialize,
  _SwitchGroup__get_serialized_size,
  _SwitchGroup__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _SwitchGroup__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SwitchGroup,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, SwitchGroup)() {
  return &_SwitchGroup__type_support;
}
