...
#include "mrs_msgs/msg/detail/goal__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // goal_id, location, task
#include "rosidl_runtime_c/string_functions.h"  // goal_id, location, task

// forward declare type support functions


using _Goal__ros_msg_type = mrs_msgs__msg__Goal;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__Goal;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__Goal * ros_message = static_cast<const mrs_msgs__msg__Goal *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__Goal(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__Goal * ros_message = static_cast<mrs_msgs__msg__Goal *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__Goal(cdr, ros_message);
}

static uint32_t _Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__Goal(
...
static size_t _Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__Goal(
