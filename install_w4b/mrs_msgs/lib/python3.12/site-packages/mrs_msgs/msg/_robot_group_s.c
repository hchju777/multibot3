...
bool mrs_msgs__msg__robot_group__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._robot_group.RobotGroup", full_classname_dest, 36) == 0);
  }
  mrs_msgs__msg__RobotGroup * ros_message = _ros_message;
  {  // robots
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->robots.data;
...
{
  /* NOTE(esteve): Call constructor of RobotGroup */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._robot_group");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotGroup");
  ...
  {  // robots
    ...
    rosidl_runtime_c__String * src = ros_message->robots.data;
