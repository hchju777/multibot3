...
#include "mrs_msgs/msg/detail/edge_ref__rosidl_typesupport_fastrtps_c.h"
...
using _EdgeRef__ros_msg_type = mrs_msgs__msg__EdgeRef;
...
{
  const _EdgeRef__ros_msg_type * ros_message = static_cast<const _EdgeRef__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__EdgeRef;
    is_plain =
      (
...
static bool _EdgeRef__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__EdgeRef * ros_message = static_cast<const mrs_msgs__msg__EdgeRef *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__EdgeRef(ros_message, cdr);
}

static bool _EdgeRef__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__EdgeRef * ros_message = static_cast<mrs_msgs__msg__EdgeRef *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__EdgeRef(cdr, ros_message);
}

static uint32_t _EdgeRef__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__EdgeRef(
      untyped_ros_message, 0));
}

static size_t _EdgeRef__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mrs_msgs__msg__EdgeRef(
...
static message_type_support_callbacks_t __callbacks_EdgeRef = {
  "mrs_msgs::msg",
  "EdgeRef",
  _EdgeRef__cdr_serialize,
  _EdgeRef__cdr_deserialize,
  _EdgeRef__get_serialized_size,
  _EdgeRef__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _EdgeRef__type_support = {
