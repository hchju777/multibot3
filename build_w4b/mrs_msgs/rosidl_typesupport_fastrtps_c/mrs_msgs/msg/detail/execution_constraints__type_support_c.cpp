...
#include "mrs_msgs/msg/detail/execution_constraints__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_msgs/msg/detail/segment__functions.h"  // segments
#include "mrs_msgs/msg/detail/switch_group__functions.h"  // switch_groups
...
bool cdr_serialize_mrs_msgs__msg__Segment(
  const mrs_msgs__msg__Segment * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_mrs_msgs__msg__Segment(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs__msg__Segment * ros_message);

size_t get_serialized_size_mrs_msgs__msg__Segment(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_mrs_msgs__msg__Segment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_mrs_msgs__msg__Segment(
  const mrs_msgs__msg__Segment * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_mrs_msgs__msg__Segment(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_mrs_msgs__msg__Segment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, Segment)();
...
using _ExecutionConstraints__ros_msg_type = mrs_msgs__msg__ExecutionConstraints;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_mrs_msgs__msg__ExecutionConstraints(
  const mrs_msgs__msg__ExecutionConstraints * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: schema
  {
  ...
  // Field name: segments
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_msgs__msg__Segment(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: switch_groups
  {
    size_t size = ros_message->switch_groups.size;
    auto array_ptr = ros_message->switch_groups.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_msgs__msg__SwitchGroup(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_deserialize_mrs_msgs__msg__ExecutionConstraints(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs__msg__ExecutionConstraints * ros_message)
{
  // Field name: schema
  {
    std::string tmp;
  ...
  // Field name: segments
  {
    ...
    if (ros_message->segments.data) {
      mrs_msgs__msg__Segment__Sequence__fini(&ros_message->segments);
    }
    if (!mrs_msgs__msg__Segment__Sequence__init(&ros_message->segments, size)) {
      fprintf(stderr, "failed to create array for field 'segments'");
      return false;
    }
    auto array_ptr = ros_message->segments.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_msgs__msg__Segment(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: switch_groups
  {
    ...
    if (ros_message->switch_groups.data) {
      mrs_msgs__msg__SwitchGroup__Sequence__fini(&ros_message->switch_groups);
    }
    if (!mrs_msgs__msg__SwitchGroup__Sequence__init(&ros_message->switch_groups, size)) {
      fprintf(stderr, "failed to create array for field 'switch_groups'");
      return false;
    }
    auto array_ptr = ros_message->switch_groups.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_msgs__msg__SwitchGroup(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_mrs_msgs__msg__ExecutionConstraints(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecutionConstraints__ros_msg_type * ros_message = static_cast<const _ExecutionConstraints__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_msgs__msg__Segment(
  ...
  // Field name: switch_groups
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_msgs__msg__SwitchGroup(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_mrs_msgs__msg__ExecutionConstraints(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_msgs__msg__Segment(
  ...
  // Field name: switch_groups
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_msgs__msg__SwitchGroup(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__ExecutionConstraints;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_key_mrs_msgs__msg__ExecutionConstraints(
  const mrs_msgs__msg__ExecutionConstraints * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: schema
  ...
  // Field name: segments
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_msgs__msg__Segment(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: switch_groups
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_msgs__msg__SwitchGroup(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_key_mrs_msgs__msg__ExecutionConstraints(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecutionConstraints__ros_msg_type * ros_message = static_cast<const _ExecutionConstraints__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: segments
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_msgs__msg__Segment(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: switch_groups
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_msgs__msg__SwitchGroup(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_key_mrs_msgs__msg__ExecutionConstraints(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_msgs__msg__Segment(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: switch_groups
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_msgs__msg__SwitchGroup(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__ExecutionConstraints * ros_message = static_cast<const mrs_msgs__msg__ExecutionConstraints *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__ExecutionConstraints(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__ExecutionConstraints * ros_message = static_cast<mrs_msgs__msg__ExecutionConstraints *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__ExecutionConstraints(cdr, ros_message);
}

static uint32_t _ExecutionConstraints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__ExecutionConstraints(
...
static size_t _ExecutionConstraints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__ExecutionConstraints(
...
static message_type_support_callbacks_t __callbacks_ExecutionConstraints = {
  "mrs_msgs::msg",
...
static rosidl_message_type_support_t _ExecutionConstraints__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ExecutionConstraints,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, ExecutionConstraints)() {
  return &_ExecutionConstraints__type_support;
}
