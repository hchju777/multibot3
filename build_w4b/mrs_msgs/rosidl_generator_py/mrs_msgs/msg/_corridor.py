...
class Metaclass_Corridor(type):
    """Metaclass of message 'Corridor'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__corridor
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__corridor
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__corridor
            cls._TYPE_SUPPORT = module.type_support_msg__msg__corridor
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__corridor
...
class Corridor(metaclass=Metaclass_Corridor):
    """Message class 'Corridor'."""
    ...
    _fields_and_field_types = {
        'id': 'string',
        'edges': 'sequence<mrs_msgs/EdgeRef>',
        'length_m': 'double',
    }
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'edges' field must be a set or sequence and each value of type 'EdgeRef'"
        self._edges = value
