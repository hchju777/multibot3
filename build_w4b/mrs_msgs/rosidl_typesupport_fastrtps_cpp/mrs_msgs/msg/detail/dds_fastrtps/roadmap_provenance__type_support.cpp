...
#include "mrs_msgs/msg/detail/roadmap_provenance__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::RoadmapProvenance & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.capacity_rule_id;

  // Member: generator_version
  cdr << ros_message.generator_version;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::RoadmapProvenance & ros_message)
{
  // Member: min_separation_m
  cdr >> ros_message.min_separation_m;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::RoadmapProvenance;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RoadmapProvenance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::RoadmapProvenance *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RoadmapProvenance__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RoadmapProvenance *>(
...
static size_t _RoadmapProvenance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RoadmapProvenance(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RoadmapProvenance__callbacks = {
  "mrs_msgs::msg",
  "RoadmapProvenance",
...
static rosidl_message_type_support_t _RoadmapProvenance__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RoadmapProvenance__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RoadmapProvenance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, RoadmapProvenance)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RoadmapProvenance__handle;
}
