...
#include "mrs_msgs/msg/detail/goal_completion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrs_msgs::msg::GoalCompletion & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::GoalCompletion & ros_message)
{
  // Member: schema
  cdr >> ros_message.schema;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_GoalCompletion(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::GoalCompletion;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_key_GoalCompletion(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::GoalCompletion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::GoalCompletion *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GoalCompletion__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::GoalCompletion *>(
...
static size_t _GoalCompletion__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GoalCompletion(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GoalCompletion__callbacks = {
  "mrs_msgs::msg",
  "GoalCompletion",
...
static rosidl_message_type_support_t _GoalCompletion__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GoalCompletion__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_GoalCompletion__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, GoalCompletion)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_GoalCompletion__handle;
}
