...
bool mrs_msgs__msg__segment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrs_msgs.msg._segment.Segment", full_classname_dest, 29) == 0);
  }
  mrs_msgs__msg__Segment * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Segment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrs_msgs.msg._segment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Segment");
