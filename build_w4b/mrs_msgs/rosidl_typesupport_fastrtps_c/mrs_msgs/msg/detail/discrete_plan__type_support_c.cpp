...
#include "mrs_msgs/msg/detail/discrete_plan__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_msgs/msg/detail/robot_plan__functions.h"  // plans
#include "mrs_msgs/msg/detail/visit_order__functions.h"  // visit_order
...
bool cdr_serialize_mrs_msgs__msg__RobotPlan(
  const mrs_msgs__msg__RobotPlan * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_mrs_msgs__msg__RobotPlan(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs__msg__RobotPlan * ros_message);

size_t get_serialized_size_mrs_msgs__msg__RobotPlan(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_mrs_msgs__msg__RobotPlan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_mrs_msgs__msg__RobotPlan(
  const mrs_msgs__msg__RobotPlan * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_mrs_msgs__msg__RobotPlan(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_mrs_msgs__msg__RobotPlan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, RobotPlan)();
...
using _DiscretePlan__ros_msg_type = mrs_msgs__msg__DiscretePlan;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_mrs_msgs__msg__DiscretePlan(
  const mrs_msgs__msg__DiscretePlan * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: schema
  {
  ...
  // Field name: plans
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_msgs__msg__RobotPlan(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: visit_order
  {
    ...
    auto array_ptr = ros_message->visit_order.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_deserialize_mrs_msgs__msg__DiscretePlan(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs__msg__DiscretePlan * ros_message)
{
  // Field name: schema
  {
    std::string tmp;
  ...
  // Field name: plans
  {
    ...
    if (ros_message->plans.data) {
      mrs_msgs__msg__RobotPlan__Sequence__fini(&ros_message->plans);
    }
    ...
    auto array_ptr = ros_message->plans.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_msgs__msg__RobotPlan(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: visit_order
  {
    ...
    if (ros_message->visit_order.data) {
      mrs_msgs__msg__VisitOrder__Sequence__fini(&ros_message->visit_order);
    }
    if (!mrs_msgs__msg__VisitOrder__Sequence__init(&ros_message->visit_order, size)) {
      fprintf(stderr, "failed to create array for field 'visit_order'");
      return false;
    }
    auto array_ptr = ros_message->visit_order.data;
    for (size_t i = 0; i < size; ++i) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_mrs_msgs__msg__DiscretePlan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DiscretePlan__ros_msg_type * ros_message = static_cast<const _DiscretePlan__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: plans
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_msgs__msg__RobotPlan(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_mrs_msgs__msg__DiscretePlan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: plans
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_msgs__msg__RobotPlan(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__DiscretePlan;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
bool cdr_serialize_key_mrs_msgs__msg__DiscretePlan(
  const mrs_msgs__msg__DiscretePlan * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: schema
  ...
  // Field name: plans
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_msgs__msg__RobotPlan(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t get_serialized_size_key_mrs_msgs__msg__DiscretePlan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DiscretePlan__ros_msg_type * ros_message = static_cast<const _DiscretePlan__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: plans
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_msgs__msg__RobotPlan(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mrs_msgs
size_t max_serialized_size_key_mrs_msgs__msg__DiscretePlan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: plans
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_msgs__msg__RobotPlan(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__DiscretePlan * ros_message = static_cast<const mrs_msgs__msg__DiscretePlan *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__DiscretePlan(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__DiscretePlan * ros_message = static_cast<mrs_msgs__msg__DiscretePlan *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__DiscretePlan(cdr, ros_message);
}

static uint32_t _DiscretePlan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__DiscretePlan(
...
static size_t _DiscretePlan__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__DiscretePlan(
...
static message_type_support_callbacks_t __callbacks_DiscretePlan = {
  "mrs_msgs::msg",
  "DiscretePlan",
...
static rosidl_message_type_support_t _DiscretePlan__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DiscretePlan,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrs_msgs, msg, DiscretePlan)() {
  return &_DiscretePlan__type_support;
}
