...
#include "mrs_msgs/msg/detail/robot_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "mrs_msgs/msg/detail/trajectory_point__functions.h"  // points
...
using _RobotTrajectory__ros_msg_type = mrs_msgs__msg__RobotTrajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mrs_msgs__msg__TrajectoryPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  mrs_msgs__msg__RobotTrajectory * ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      mrs_msgs__msg__TrajectoryPoint__Sequence__fini(&ros_message->points);
    }
    if (!mrs_msgs__msg__TrajectoryPoint__Sequence__init(&ros_message->points, size)) {
      fprintf(stderr, "failed to create array for field 'points'");
      return false;
    }
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mrs_msgs__msg__TrajectoryPoint(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrs_msgs__msg__TrajectoryPoint(
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrs_msgs__msg__TrajectoryPoint(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs__msg__RobotTrajectory;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mrs_msgs__msg__TrajectoryPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mrs_msgs__msg__TrajectoryPoint(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mrs_msgs__msg__TrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mrs_msgs__msg__RobotTrajectory * ros_message = static_cast<const mrs_msgs__msg__RobotTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mrs_msgs__msg__RobotTrajectory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mrs_msgs__msg__RobotTrajectory * ros_message = static_cast<mrs_msgs__msg__RobotTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mrs_msgs__msg__RobotTrajectory(cdr, ros_message);
}

static uint32_t _RobotTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrs_msgs__msg__RobotTrajectory(
...
static size_t _RobotTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrs_msgs__msg__RobotTrajectory(
