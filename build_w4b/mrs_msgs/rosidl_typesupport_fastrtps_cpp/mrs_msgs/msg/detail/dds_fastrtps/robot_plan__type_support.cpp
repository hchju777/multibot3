...
#include "mrs_msgs/msg/detail/robot_plan__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mrs_msgs::msg::PlanStep &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mrs_msgs::msg::PlanStep &);
...
cdr_serialize(
  const mrs_msgs::msg::RobotPlan & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::RobotPlan & ros_message)
{
  // Member: robot
  cdr >> ros_message.robot;
  ...
  // Member: steps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.steps[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: steps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PlanStep(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::RobotPlan;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: steps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_PlanStep(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RobotPlan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::RobotPlan *>(
    untyped_ros_message);
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RobotPlan__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, RobotPlan)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RobotPlan__handle;
}
