...
#include "mrs_msgs/msg/detail/robot_specs__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_RobotSpec(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const mrs_msgs::msg::RobotSpecs & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrs_msgs::msg::RobotSpecs & ros_message)
{
  // Member: schema
  cdr >> ros_message.schema;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_RobotSpecs(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: robots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RobotSpec(
  ...
  if (is_plain) {
    ...
    using DataType = mrs_msgs::msg::RobotSpecs;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mrs_msgs
max_serialized_size_key_RobotSpecs(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: robots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrs_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_RobotSpec(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RobotSpecs *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrs_msgs::msg::RobotSpecs *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotSpecs__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrs_msgs::msg::RobotSpecs *>(
...
static size_t _RobotSpecs__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotSpecs(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotSpecs__callbacks = {
  "mrs_msgs::msg",
  "RobotSpecs",
...
static rosidl_message_type_support_t _RobotSpecs__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotSpecs__callbacks,
...
{
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RobotSpecs__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrs_msgs, msg, RobotSpecs)() {
  return &mrs_msgs::msg::typesupport_fastrtps_cpp::_RobotSpecs__handle;
}
